...
// CWordDocument wrapper class

class CWordDocument : public COleDispatchDriver
{
public:
	CWordDocument() {} // Calls COleDispatchDriver default constructor
	CWordDocument(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordDocument(const CWordDocument& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		BOOL result;
		InvokeHelper(0x270, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_AutoSaveOn(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x270, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	void ExportAsFixedFormat2(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, long Range, long From, long To, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, BOOL BitmapMissingFonts, BOOL UseISO19005_1, BOOL OptimizeForImageQuality, VARIANT * FixedFormatExtClassPtr)
	{
		static BYTE parms[] = VTS_BSTR VTS_I4 VTS_BOOL VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_BOOL VTS_BOOL VTS_I4 VTS_BOOL VTS_BOOL VTS_BOOL VTS_BOOL VTS_PVARIANT;
		InvokeHelper(0x271, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, OutputFileName, ExportFormat, OpenAfterExport, OptimizeFor, Range, From, To, Item, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts, UseISO19005_1, OptimizeForImageQuality, FixedFormatExtClassPtr);
	}
	LPDISPATCH get_SensitivityLabel()
	{
		LPDISPATCH result;
		InvokeHelper(0x272, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
