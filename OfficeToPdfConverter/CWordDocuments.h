...
// CWordDocuments wrapper class

class CWordDocuments : public COleDispatchDriver
{
public:
	CWordDocuments() {} // Calls COleDispatchDriver default constructor
	CWordDocuments(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordDocuments(const CWordDocuments& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
