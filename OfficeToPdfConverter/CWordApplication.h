...
// CWordApplication wrapper class

class CWordApplication : public COleDispatchDriver
{
public:
	CWordApplication() {} // Calls COleDispatchDriver default constructor
...
public:
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x58, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_Width()
	{
		long result;
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x59, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_Height()
	{
		long result;
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x5a, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x5b, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x6e, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	void PrintOutOld(VARIANT * Background, VARIANT * Append, VARIANT * Range, VARIANT * OutputFileName, VARIANT * From, VARIANT * To, VARIANT * Item, VARIANT * Copies, VARIANT * Pages, VARIANT * PageType, VARIANT * PrintToFile, VARIANT * Collate, VARIANT * FileName, VARIANT * ActivePrinterMacGX, VARIANT * ManualDuplexPrint)
	{
		...
		InvokeHelper(0x12e, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Background, Append, Range, OutputFileName, From, To, Item, Copies, Pages, PageType, PrintToFile, Collate, FileName, ActivePrinterMacGX, ManualDuplexPrint);
	}
	void LookupNameProperties(LPCTSTR Name)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x12f, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Name);
	}
	void SubstituteFont(LPCTSTR UnavailableFont, LPCTSTR SubstituteFont)
	{
		static BYTE parms[] = VTS_BSTR VTS_BSTR;
		InvokeHelper(0x130, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, UnavailableFont, SubstituteFont);
	}
	...
	void DDEExecute(long Channel, LPCTSTR Command)
	{
		...
		InvokeHelper(0x136, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Channel, Command);
	}
	...
	void DDEPoke(long Channel, LPCTSTR Item, LPCTSTR Data)
	{
		...
		InvokeHelper(0x138, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Channel, Item, Data);
	}
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x13a, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Channel);
	}
	...
	void OrganizerCopy(LPCTSTR Source, LPCTSTR Destination, LPCTSTR Name, long Object)
	{
		...
		InvokeHelper(0x13e, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Source, Destination, Name, Object);
	}
	void OrganizerDelete(LPCTSTR Source, LPCTSTR Name, long Object)
	{
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_I4;
		InvokeHelper(0x13f, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Source, Name, Object);
	}
	void OrganizerRename(LPCTSTR Source, LPCTSTR Name, LPCTSTR NewName, long Object)
	{
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4;
		InvokeHelper(0x140, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Source, Name, NewName, Object);
	}
	void AddAddress(SAFEARRAY * * TagID, SAFEARRAY * * Value)
	{
		static BYTE parms[] = VTS_UNKNOWN VTS_UNKNOWN;
		InvokeHelper(0x141, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, TagID, Value);
	}
	...
	{
		static BYTE parms[] = VTS_PVARIANT;
		InvokeHelper(0x149, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, HelpType);
	}
	...
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x15a, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ListAllCommands);
	}
	void ShowClipboard()
	{
	...
	void OnTime(VARIANT * When, LPCTSTR Name, VARIANT * Tolerance)
	{
		...
		InvokeHelper(0x15e, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, When, Name, Tolerance);
	}
	void NextLetter()
	{
	...
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x165, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Path);
	}
	void RunOld(LPCTSTR MacroName)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x166, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, MacroName);
	}
	void GoForward()
	{
	...
	void Move(long Left, long Top)
	{
		...
		InvokeHelper(0x168, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Left, Top);
	}
	void Resize(long Width, long Height)
	{
		static BYTE parms[] = VTS_I4 VTS_I4;
		InvokeHelper(0x169, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Width, Height);
	}
	...
	void KeyboardLatin()
	{
		InvokeHelper(0x190, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void KeyboardBidi()
	{
	...
	void ToggleKeyboard()
	{
		InvokeHelper(0x192, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	...
	{
		CString result;
		InvokeHelper(0x194, DISPATCH_METHOD, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH DefaultWebOptions()
	{
		LPDISPATCH result;
		InvokeHelper(0x195, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	void DiscussionSupport(VARIANT * Range, VARIANT * cid, VARIANT * piCSE)
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0x197, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Range, cid, piCSE);
	}
	void SetDefaultTheme(LPCTSTR Name, long DocumentType)
	{
		static BYTE parms[] = VTS_BSTR VTS_I4;
		InvokeHelper(0x19e, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Name, DocumentType);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x185, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	long get_Language()
	{
		long result;
		InvokeHelper(0x187, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_COMAddIns()
	{
		LPDISPATCH result;
		InvokeHelper(0x6f, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x1bf, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_FeatureInstall(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x1bf, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	void PrintOut2000(VARIANT * Background, VARIANT * Append, VARIANT * Range, VARIANT * OutputFileName, VARIANT * From, VARIANT * To, VARIANT * Item, VARIANT * Copies, VARIANT * Pages, VARIANT * PageType, VARIANT * PrintToFile, VARIANT * Collate, VARIANT * FileName, VARIANT * ActivePrinterMacGX, VARIANT * ManualDuplexPrint, VARIANT * PrintZoomColumn, VARIANT * PrintZoomRow, VARIANT * PrintZoomPaperWidth, VARIANT * PrintZoomPaperHeight)
	{
		...
		InvokeHelper(0x1bc, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Background, Append, Range, OutputFileName, From, To, Item, Copies, Pages, PageType, PrintToFile, Collate, FileName, ActivePrinterMacGX, ManualDuplexPrint, PrintZoomColumn, PrintZoomRow, PrintZoomPaperWidth, PrintZoomPaperHeight);
	}
	...
	{
		static BYTE parms[] = VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT;
		InvokeHelper(0x1c0, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Background, Append, Range, OutputFileName, From, To, Item, Copies, Pages, PageType, PrintToFile, Collate, FileName, ActivePrinterMacGX, ManualDuplexPrint, PrintZoomColumn, PrintZoomRow, PrintZoomPaperWidth, PrintZoomPaperHeight);
	}
	long get_AutomationSecurity()
	{
		long result;
		InvokeHelper(0x1c1, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		CString result;
		InvokeHelper(0x1c3, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	...
	{
		BOOL result;
		InvokeHelper(0x1c4, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1c6, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_ShowStartupDialog()
	{
		BOOL result;
		InvokeHelper(0x1c7, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_ShowStartupDialog(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1c7, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	LPDISPATCH get_AutoCorrectEmail()
	{
		LPDISPATCH result;
		InvokeHelper(0x1c8, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_TaskPanes()
	{
		LPDISPATCH result;
		InvokeHelper(0x1c9, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_DefaultLegalBlackline()
	{
		BOOL result;
		InvokeHelper(0x1cb, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_DefaultLegalBlackline(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1cb, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL Dummy2()
	{
		BOOL result;
		InvokeHelper(0x1ca, DISPATCH_METHOD, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	...
	{
		InvokeHelper(0x1d0, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	BOOL get_ArbitraryXMLSupportAvailable()
	{
		BOOL result;
		InvokeHelper(0x1d1, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	CString get_BuildFull()
	{
		CString result;
		InvokeHelper(0x1d2, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	CString get_BuildFeatureCrew()
	{
		CString result;
		InvokeHelper(0x1d3, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
	void LoadMasterList(LPCTSTR FileName)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x1d5, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, FileName);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1d8, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1db, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_DisplayDocumentInformationPanel()
	{
		BOOL result;
		InvokeHelper(0x1dc, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_DisplayDocumentInformationPanel(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1dc, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	LPDISPATCH get_Assistance()
	{
		LPDISPATCH result;
		InvokeHelper(0x1dd, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x1df, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	BOOL get_DontResetInsertionPointProperties()
	{
		BOOL result;
		InvokeHelper(0x1e0, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_DontResetInsertionPointProperties(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1e0, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	LPDISPATCH get_SmartArtLayouts()
	{
		LPDISPATCH result;
		InvokeHelper(0x1e1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_SmartArtQuickStyles()
	{
		LPDISPATCH result;
		InvokeHelper(0x1e2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_SmartArtColors()
	{
		LPDISPATCH result;
		InvokeHelper(0x1e3, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	void ThreeWayMerge(LPDISPATCH LocalDocument, LPDISPATCH ServerDocument, LPDISPATCH BaseDocument, BOOL FavorSource)
	{
		...
		InvokeHelper(0x1e4, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, LocalDocument, ServerDocument, BaseDocument, FavorSource);
	}
	void Dummy4()
	{
		InvokeHelper(0x1e5, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1e9, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1eb, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_IsSandboxed()
	{
		BOOL result;
		InvokeHelper(0x1ec, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	...
	{
		BOOL result;
		InvokeHelper(0x1ee, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_ChartDataPointTrack(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1ee, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_ShowAnimation()
	{
		BOOL result;
		InvokeHelper(0x1ef, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_ShowAnimation(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1ef, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1f1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
