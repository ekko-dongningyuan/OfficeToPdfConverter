...
// CExcelWorkbooks wrapper class

class CExcelWorkbooks : public COleDispatchDriver
{
public:
	CExcelWorkbooks() {} // Calls COleDispatchDriver default constructor
	CExcelWorkbooks(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcelWorkbooks(const CExcelWorkbooks& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
